...
public class Platforms {
    ...
    public Platforms() {
        ...
        platforms.add(new Platform((int) (Width / 11 + Width * 0.5 - Width / 22), (int) (Height * 0.95), (int) (Width / 11 + Width * 0.56 + Width / 22), (int) (Height * 0.983), new Color(106, 114, 114), 2, true));
    }
